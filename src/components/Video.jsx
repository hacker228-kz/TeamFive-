  ...
  return (
    <div className="w-full overflow-hidden">
      <div className="relative">
        ...
        <h2 className="absolute bottom-[140px] left-1/2 transform -translate-x-1/2 text-white text-center font-manrope text-[60px] font-extrabold leading-[72px] tracking-[-4px] w-[698.8px] ml-[40px]">
