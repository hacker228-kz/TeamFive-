...
import avatarW from "../assets/avatarW.svg";
...
function Testimonial() {
  return (
    <div className="w-full relative mt-[-68px]">
      ...
      <h4 className="absolute top-[130px] ml-[770px] transform -translate-x-1/2 text-[#EEC044] text-center font-covered text-[24px]">
        Our Testimonials
      </h4>
