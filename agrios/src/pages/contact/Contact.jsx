...
import fromBg from '../../assets/images/fromBg.svg'; // Ensure this file exists in the specified path
...
const Contact = () => {
  return (
    <div id='contact' className="min-h-screen bg-white">
      ...
      <div className="flex justify-center mt-10 mb-10 transition-transform duration-300 hover:scale-[1.02]">
        <div className="w-[900px] bg-white p-9 rounded-xl ">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-20">
            ...
            <div className="bg-[#C5CE38] p-9 rounded-lg transition-transform duration-300 hover:scale-[1.02]">
            ...
            <div className="bg-[#EEC044] p-9 rounded-lg transition-transform duration-300 hover:scale-[1.02]">
