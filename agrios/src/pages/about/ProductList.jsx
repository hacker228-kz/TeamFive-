  ...
  return (
    <div className=" mt-[50px] ml-[200px]">
      <div className="w-[370px] h-[377px] pt-[42px] px-[50px] pb-[36px] rounded-[10px] bg-[#F8F7F0]">
        <h4 className="w-[110px] h-[30px] text-[#1F1E17] text-[20px] font-manrope font-bold leading-[30px]">
          Categories
        </h4>
      ...
      <div className="w-[370px] h-[400px] rounded-[10px] mt-[30px]">
        ...
        <h4 className="w-[134px] h-[30px] text-[#FFF] text-[20px] font-manrope font-extrabold leading-[30px] mt-[-380px] ml-[125px]">
          Need Help?
        </h4>
        ...
        <h6 className="w-[280px] h-[67.5] text-[#FFF] text-[25px] font-first font-normal leading-[67.5px] ml-[90px]">
          +92 (000) -9630
        </h6>
      ...
      <div className="w-[800px] h-[1692px] mt-[-807px] ml-[400px]">
        ...
        <h2 className="w-[413.7px] h-[56px] text-[#1F1E17] text-[40px] font-manrope font-bold mt-[30px] leading-[56px]">
          Agriculture Products
        </h2>
        ...
        <div className="w-[800px] h-[384px] mt-[50px]">
          <div className="w-[400px] h-[384px]">
            ...
            <h4 className="w-[185px] h-[36px] text-[#1F1E17] text-[30px] font-manrope font-bold mt-[15px]">
              Our Benefits
            </h4>
            <p className="w-[365.5px] h-[90px] text-[#878680] text-[15px] font-manrope font-medium mt-[50px] leading-[30px]">
      ...
      <div className="w-[770px] h-[440px] ml-[400px] mt-[-350px]">
        {/* Accordion Item 1 */}
        <div className="relative w-[770px] rounded-[10px] bg-[#F8F7F0] mb-[20px]">
          <div 
            className="flex items-center justify-between h-[80px]  cursor-pointer"
            onClick={() => toggleSection(0)}
          >
            <h4 className="w-[388px] h-[30px] text-[#1F1E17] text-[20px] font-manrope font-bold leading-[30px]  ml-[38px]">
          ...
          {activeIndex === 0 && (
            <p className="w-[719px] h-[90px] text-[#878680] text-[16px] font-manrope font-medium leading-[30px] pb-[30px] ml-[40px]">
        ...
        {/* Accordion Item 3 */}
        <div className="relative w-[770px] rounded-[10px] bg-[#F8F7F0]">
          <div 
            className="flex items-center justify-between h-[80px] cursor-pointer"
